...
public class ForwardingService {
    ...
    private static void forwardCoins(Transaction tx) {
        try {
            ...
            final Coin amountToSend = value.subtract(kit.params().isDIP0001ActiveAtTip() ? Transaction.REFERENCE_DEFAULT_MIN_TX_FEE.div(10) : Transaction.REFERENCE_DEFAULT_MIN_TX_FEE);
